  ...
  export default defineComponent({
    ...
    setup: function () {
      ...
      const ListAllSlide = (params: any) => {
        axios.post("http://127.0.0.1:9000/business/admin/collaboration-UK-Ireland/list", {
          page: params.page,
          size: params.size,
        }).then((response) => {
      ...
      const saveFile = () => {
        ...
        axios.post('http://127.0.0.1:9000/business/admin/collaboration-UK-Ireland/save', {
      ...
      const deleteFile = (row: any) => {
        axios.get('http://127.0.0.1:9000/business/admin/collaboration-UK-Ireland/delete/' + row.id).then((response) => {
          const data = response.data;
          if (data.success) {
      ...
      const jumpToDetail = (row: any) => {
        ...
        router.push("/detail/UK-Ireland/detail");
