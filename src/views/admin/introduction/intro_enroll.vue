...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const ListAllInfo = () => {
        axios.get(process.env.VUE_APP_SERVER + "/business/admin/intro-enroll/list").then((response) => {
      ...
      //保存编辑
      const saveEdit = () => {
        axios.post(process.env.VUE_APP_SERVER + '/business/admin/intro-enroll/save', {
          id:'00000001',
